        ...
        <el-row :gutter="20">
          ...
          >
            ...
            <div v-else>
              ...
              <el-form-item
                v-else-if="item.field !== 'bdnm' && item.field !== 'mtnm'"
                :label="isNm(item)"
                :name="item.field"
              >
                <el-date-picker
        ...
        >
          <el-row :gutter="20">
            ...
            >
              ...
              <el-form-item v-else :label="isNm(item2)" :name="item2.field">
                <el-select
                  class="w100"
      ...
      if (this.data.fields && this.data.fields.length > 0) {
        this.data.fields.forEach((item) => {
          if (item.require === "1") {
            ...
            console.log(item.field, item.require);
          }
        });
      }
