      ...
      >
        ...
        <div v-if="Array.isArray(item)">
          <tab-inner-table
            ...
            :showIndex="true"
            :showSelect="true"
            :showAdd="item[0].tableName != '北斗' ? true : false"
            :showDelete="item[0].tableName != '北斗' ? true : false"
            :canEdit="true"
            :type="`add`"
            :pkey="pkey"
            :skey="skey"
              ...
              >
                <div v-if="!isSelect(selects, item2.field)">
                  ...
                  <div v-else>
                    <el-form-item
                      :prop="item2.field"
                      v-if="item2.field !== 'bdnm' && item2.field !== 'mtnm'"
                      :label="isNm(item2)"
                      :name="item2.field"
                    >
                      <el-date-picker
...
export default {
  name: "addDialog",
  props: ["data", "pkey", "skey", "zbList", "zbSelect"],
  ...
  created() {
    ...
    Object.assign(this.selects, this.zbSelect.zb);
